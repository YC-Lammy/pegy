...
use super::{float::Float, common::AdjustedMantissa, decimal::{parse_decimal, Decimal}};

#[inline]
pub async fn parse_long_mantissa<F: Float, S:Source>(src: &mut S) -> AdjustedMantissa {
    ...
    let mut d = parse_decimal(src).await;
